...
\]
This simplifies to the formula used in the paper:
\[
...
La fórmula para σestσest​ asume que la covarianza entre (r−J0660) y (r−i), debida a su dependencia compartida de la banda r, es despreciable. Esto es válido dado que los errores fotométricos en r (σr∼0.01σ mag) son mucho menores que los de i y J0660 (σi, σJ0660∼0.1 σi​, σJ0660​∼0.1 mag). El término σs2 incluye además cualquier dispersión intrínseca no capturada por el modelo.

The factor (1−m)2 ensures that the contribution of σr2​ is weighted by the sensitivity of the linear fit, avoiding artificial duplication. This approach follows standard error propagation for models with correlated variables \citep{Lyons:1991}
