...
def filter_mag(e, s, f1, f2, f3, f4, data):
    '''
    ...
    for file_name in file_list:
        with open(file_name) as f:
            ...
            if classification == 'MS':
                x, y = filter_mag("Star", "", f1, f2, f3, f4, data)
                MS_A1.extend(x)
                MS_B1.extend(y)
...
A1_MS, B1_MS, A1_giant, B1_giant = plot_mag("F0626_rSDSS", "F0660", "F0883_zSDSS", "F0861")
...
plt.savefig(f"Figs/Halpha-objects-MS-F861.pdf")
