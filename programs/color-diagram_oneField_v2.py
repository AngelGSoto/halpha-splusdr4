...
parser.add_argument("--Field", type=str, default="b'STRIPE82-0142'", help="Choosing a field")

parser.add_argument("--Object", type=str, default="b'iDR4_3_STRIPE82-0142_0021237'", help="Choosing a individual object in the Field")

parser.add_argument("--Ranger", type=str, default="r < 16", help="Range on r-magnitude")
...
# Using astropy to do the fit line
...
ax.text(0.05, 0.95, f'$y = {a:.2f}x + {b:.2f}$', transform=ax.transAxes, fontsize=15, verticalalignment='top')

# Saving the plot as a png file
output_dir = Path(cmd_args.fileName)
output_dir.mkdir(parents=True, exist_ok=True)
plot_path = f"Figs/color-color-diagram_{cmd_args.Field}_v2.pdf"
plt.savefig(plot_path)
plt.close()

print(f"Figure {plot_path} created successfully!")
