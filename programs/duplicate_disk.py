...
tree = KDTree(data[['ALPHA', 'DELTA']].values, leaf_size=30)
...
for i, row in data.iterrows():
    indices = tree.query_radius([[row['ALPHA'], row['DELTA']]], r=coordinate_threshold)
...
for obj1, obj2 in potential_duplicates:
    ...
    print(obj1[['field', 'NUMBER', 'ALPHA', 'DELTA']])
    print(obj2[['field', 'NUMBER', 'ALPHA', 'DELTA']])
    print("-----------------------------")
