...
# Load data
df_splus = open_csv_conc("Class_disk-unique/Halpha_emitter_disk*.csv", "simbad")
df_splus_wise = open_csv_conc("Class_disk-wise-unique/*.csv", "simbad")
...
# Plotting SPLUS data
def plot_data(df, filename,  xlabel, ylabel):
...
# Plot SPLUS
plot_data(df_splus, "Figs/umap_hdbscam_splus_disk.pdf",  "UMAP-1", "UMAP-2")

# Plot SPLUS + WISE
plot_data(df_splus_wise, "Figs/umap_hdbscam_splus_wise_disk.pdf",  "UMAP-1", "UMAP-2")
