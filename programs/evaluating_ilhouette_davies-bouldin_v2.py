...
# Define a range of number of components, neighbors, and clusters to try
...
# Loop over different numbers of components, neighbors, and clusters
for num_components in n_components_range:
    for n_neighbors in n_neighbors_range:
        ...
        for n_clusters in n_clusters_range:
            ...
            print(f"Components: {num_components}, Neighbors: {n_neighbors}, Clusters: {n_clusters}, Silhouette Score: {silhouette}, DB Index: {davies_bouldin}")
...
#lt.savefig("Figs/Silhouette_Score_Davies-Bouldin_wise.pdf")
