...
plt.tick_params(axis='x', labelsize=20)
plt.tick_params(axis='y', labelsize=20)
sns.kdeplot(df_halpha_d["GAL_LONG"], color='navy', label='Hα Excess (Galactic Disk)', linestyle='-', linewidth=2, zorder=3)
sns.kdeplot(galactic_coords_d.l.deg, color='salmon', label='All Galactic Disk Stars', linestyle='--', linewidth=2, zorder=2)
