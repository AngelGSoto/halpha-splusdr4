...
fig, axes = plt.subplots(3, 3, figsize=(16, 14), dpi=300)  # 2 rows, 3 columns
...
for i, ((x1, y1), (x2, y2)) in enumerate(specific_pairs):
    ...
    plt.subplots_adjust(wspace=0.3, hspace=0.3)  # Adjust to increase space between subplots
...
plt.tight_layout()
plt.savefig("Figs/color_color_diagrams_multiple_balanced.pdf", format='pdf', bbox_inches='tight', dpi=300)
plt.close()
